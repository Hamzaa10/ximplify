        ...
        <div className={style.container}>
            <div className={style.grid}>
                <div className={style.leftDiv}>
                    ...
                    <p className={style.p3}>{userMail ? userMail : 'psychopath@hell.com'}</p>
                    <div className={style.codeDiv}>
                        <Code label='Confirmation Code' />
                    </div>
                    <div className={style.timer}>
                        {secondsLeft > 0 ? (
                            <p>The OTP will be expired in: <span className={style.countdown}>{formatCountdown(secondsLeft)}</span></p>
                        ) : (
                    ...
                    <div className={style.logIn}>
                        ...
                        <span className={style.btnText} style={{ cursor: isResendDisabled ? 'not-allowed' : 'pointer' }}
                            onClick={() => { isResendDisabled ? null : window.location.reload() }}>Resend Code</span>
                    </div>
                </div>
